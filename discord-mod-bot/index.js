...
//    - أضف أي كلمة جديدة بسهولة: فقط أضف سطر 'الكلمة',
//    - العبارات المكوّنة من أكثر من كلمة تُكتب زي ما هي بمسافة عادية
// ================================================================
const BANNED_WORDS = [
  // --- عبارات وشتائم بالأهل والأعراض ---
  'كسمك', 'كس امك', 'كس ابوك', 'كس اختك', 'كس اهلك', 'كس خالتك', 'كس عمتك', 'كس جدتك', 'كس عمك', 'كس خالك',
  'يلعن ابوك', 'يلعن امك', 'يلعن اختك', 'يلعن عرضك', 'لعن ابوك', 'لعن امك',
  'منيوك', 'منيوكة', 'منياك', 'ابن الكلب', 'بنت الكلب', 'ابن الحرام', 'بنت الحرام',
  'ابن القحبة', 'بنت القحبة', 'ابن الزانية',
  'شرموط', 'شرموطة', 'عاهرة', 'قحبة', 'القحبة',
  'خول', 'خنيث', 'لوطي', 'لواط', 'ديوث', 'دياثة', 'عرص',
  'زاني', 'زانية', 'داعر', 'داعرة', 'فاجر', 'فاجرة', 'متناك', 'متناكة',

  // --- سبّات وإهانات عامة ---
  'يا واطي', 'يا حقير', 'يا نجس', 'يا وسخ', 'يا قذر', 'يا سافل', 'يا رخيص', 'يا خسيس', 'يا نذل', 'يا وضيع',
  'يا خبيث', 'يا لعين', 'يا كلب', 'يا حمار', 'يا خنزير', 'يا تافه', 'يا غبي', 'يا احمق', 'يا معتوه', 'يا مجنون',
  'يا معفن', 'يا عفن', 'يا زبالة', 'يا حثالة', 'قليل الحيا', 'قليل تربية', 'عديم التربية', 'عديم الاصل',
  'يا صايع', 'يا ضايع', 'يا منحط', 'يا ساقط', 'يا عرة', 'يا جربوع', 'يا خايس', 'يا مقرود', 'يا ملقوف',

  // --- لهجات خليجية وبدوية ---
  'مهوب رجال', 'مو رجال', 'خبل', 'رخمة', 'خكري', 'صايع', 'طفران', 'ملعون والدين',
  'يا طرطور', 'يا إمعة', 'يا خيشة', 'يا جدر', 'يا صخل', 'يا نعجه', 'يا فلاتي', 'يا همل', 'يا طقعان', 'يا نحس',

  // --- عبارات مصرية / شامية / مغربية ---
  'يا ابن الوسخة', 'يا زلمة وسخ', 'يا بيئة', 'يا سوقي', 'يلعن مخك', 'يلعن شرفك',
  'يا فلاح', 'يا ابن الستين داهية', 'يا اجرب', 'يا عبيط', 'يا متخلف', 'يا خايب',
  'يا نكرة', 'يا بايظ', 'يا خرابيط', 'يا مغفل', 'يا بهيم', 'يا مقرف', 'يا اهبل', 'يا فاشل',
  'يا خرب بيتك', 'يا خاين', 'يا غادر', 'يا جبان',

  // --- كتابة مشفّرة بالنقاط / الشرطات (تحايل شائع) ---
  ...
  'pussy', 'cunt', 'faggot', 'retard', 'douchebag', 'scumbag', 'moron',
  'dumbass', 'piece of shit', 'screw you', 'skank', 'twat', 'wanker', 'prick', 'shithead',
];
